...
export class CloudAgent extends HeyApiClient {
   ...
   *
   * Returns the bearer token and facade URL for extension-host Cloud Agent SDK calls. This explicit localhost capability must not expose the returned bearer to a browser webview.
   */
