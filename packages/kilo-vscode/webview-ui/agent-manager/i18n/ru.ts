export const dict = {
  ...
  "agentManager.cloud.loading": "Загрузка Cloud Agents...",
  "agentManager.cloud.empty": "Cloud Agents не найдены.",
  "agentManager.cloud.failed": "Не удалось загрузить Cloud Agents.",
  "agentManager.cloud.retry": "Повторить",
  "agentManager.cloud.unsupportedAction": "Это действие не поддерживается для Cloud Agents.",
