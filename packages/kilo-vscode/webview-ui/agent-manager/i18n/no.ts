export const dict = {
  ...
  "agentManager.cloud.loading": "Laster Cloud Agents...",
  "agentManager.cloud.empty": "Ingen Cloud Agents funnet.",
  "agentManager.cloud.failed": "Kunne ikke laste Cloud Agents.",
  "agentManager.cloud.retry": "Prøv igjen",
  "agentManager.cloud.unsupportedAction": "Denne handlingen støttes ikke for Cloud Agents.",
