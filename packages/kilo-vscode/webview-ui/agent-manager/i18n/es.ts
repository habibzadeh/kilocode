export const dict = {
  ...
  "agentManager.cloud.loading": "Cargando Cloud Agents...",
  "agentManager.cloud.empty": "No se encontraron Cloud Agents.",
  "agentManager.cloud.failed": "No se pudieron cargar los Cloud Agents.",
  "agentManager.cloud.retry": "Reintentar",
  "agentManager.cloud.unsupportedAction": "Esta acción no es compatible con Cloud Agents.",
